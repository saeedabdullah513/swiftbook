...
export const Route = createFileRoute("/v3/trust/pricing")({
  ...
  component: () => (
    <TrustPage title="Pricing & Third-Party Costs" eyebrow="Policy">
      ...
      <ul>
        ...
        <li>Gift cards, author stipends, or reader incentives paid without written approval.</li>
        <li>Any cost not listed in the signed scope of work.</li>
      </ul>
    </TrustPage>
  ),
});
